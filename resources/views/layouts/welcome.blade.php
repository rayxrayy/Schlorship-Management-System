...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <ul class="nav-list white">
                            ...
                            <li class="nav-item"><a href="/college" class="nav-link" id="menu_lectures">College
                                    Partners</a></li>
                            <li class="nav-item"><a href="/review" class="nav-link" id="menu_faqs">Reviews</a></li>
                            <li class="nav-item"><a href="/blog" class="nav-link" id="menu_insights">Blog</a></li>
                            <li class="nav-item">
                                @if (Route::has('login'))
                                ...
                                <a href="{{ route('register') }}" class="nav-link nav-btn"
                                    ...
                                    id="menu_apply-aiFellowship">Get
                                    Started</a>
                                @endif
                                @endauth
    ...
    /* <![CDATA[ */
    var pp_ajax_form = {
        "ajaxurl": "https:\/\/insights.fuse.ai\/wp-admin\/admin-ajax.php",
