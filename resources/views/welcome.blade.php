...
<head>
    ...
    .button-container a {
        ...
        /* Adjust this value to control the underline color and thickness */
        color: #c21807;
        font-weight: 600;
    ...
    .button-container a:hover {
        border-bottom: 2px solid #6f39eb;
        /* Adjust this value to match the hover underline color and thickness */
        color: #6f39eb;
    }
    ...
    .footer-container {
        ...
        margin-top: 100px;
        /* Adjust this value to control the space between buttons and footer content */
        font-size: 18px;
    }
    ...
    .main {
        margin-top: 70px;
        /* Adjust as needed to create space between header and content */
        padding: 20px;
    }
    </style>
</head>
    ...
    <div class="navbar-container">
        ...
        <div class="button-container">
            ...
            <div>
                ...
                @else
                <a href="{{ route('login') }}" style="font-style: lato; margin-left: 80px; color:#c21807;"></a>

                @if (Route::has('register'))
                <a href="{{ route('register') }}"
                    style="font-style: lato; margin-left: 40px; margin-right: 60px; color:#c21807;"> GET STARTED</a>
                @endif
                @endauth
            </div>
            @endif
        ...
        <div class="button-container" style="margin-right:400px; font:initial;">
            ...
            <div class="dropdown">
                <a href="#" onclick="toggleDarkMode()"
                    style="margin-left: 50px;margin-right: 50px; color:#c21807;">Company</a>
            ...
            <a href="#" onclick="toggleDarkMode()"
                style="margin-left:50px; margin-right: 50px; white-space: nowrap;">Contact Us</a>
...
<main class="landing-page">
    ...
    <section class="three-sections">
        ...
        <div class="section">
            <h2>Section 1</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vestibulum, turpis nec consequat
                consequat.</p>
        </div>
        <!-- Section 2 -->
        <div class="section">
    ...
    <footer>
        <div class="footer-content">
            <div>
                <a href="https://github.com/rayxrayy/Schlorship-Management-System" target="_blank"
                    style="margin-left: 560px;">© Copyright 2024 Edu-Hope Inc. | All rights reserved</a>
